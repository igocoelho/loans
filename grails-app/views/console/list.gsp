	...
	<body>
		...
		<div id="list-console" class="content scaffold-list" role="main">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						<td><g:message code="console.name.label" default="Name" /></td>
						<td>&nbsp;</td>
					</tr>
				</thead>
				<tbody>
				<g:each in="${consoleInstanceList}" status="i" var="consoleInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="edit" id="${consoleInstance.id}"><i class="icon-edit"></i></g:link>&nbsp;<a href="javascript:deleteDomain('/loan/console/delete', ${consoleInstance.id})"><i class="icon-remove"></i></a>
						</td>
					</tr>
				</g:each>
				</tbody>
